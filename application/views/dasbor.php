                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="<?php echo base_url('welcome/tambah') ?>">Table</a></li>
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td> <?php $hasil = $row->judul; 
                                                        $snippet = substr($hasil, 0,35);
                                                        echo $snippet;?>....</td>
                                            <td> <?php echo $row->penulis; ?></td>
                                            <td> <?php echo $row->tanggal; ?></td>
                                            <td> <?php echo $row->kategori; ?></td>
                                            <td align="center">
                                                <a href="<?php echo base_url('welcome/edit') ?>/<?php echo $row->idartikel;?>" class="btn btn-outline-success" role="button">Edit</a>
                                                <a href="<?php echo base_url('welcome/delete') ?>/<?php echo $row->idartikel;?>" class="btn btn-outline-danger" role="button">Delete</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                    </tbody>
