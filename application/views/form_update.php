...
<head>
    ...
    <title>Panel Admin - Edit Data</title>
        ...
        <header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header">
                    <a class="navbar-brand" href="<?php echo base_url('admin/admin_tampil')?>/<?php echo $this->session->userdata('username');?>"><img src="<?php echo base_url();?>assets/dasbor/images/logo.png" alt="Logo"></a>
                    <a class="navbar-brand hidden" href="<?php echo base_url('admin/admin_tampil')?>/<?php echo $this->session->userdata('username');?>"><img src="<?php echo base_url();?>assets/dasbor/images/logo2.png" alt="Logo"></a>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    <li><a href="<?php echo base_url('admin/admin_tampil')?>/<?php echo $this->session->userdata('username');?>">Dashboard</a></li>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="<?php echo base_url('welcome/update_artikel');?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    <div class="row form-group">
                                        <div class="col-12 col-md-9"><input type="hidden" id="text-input" name="idartikel" placeholder="Text" class="form-control" value="<?php echo $row->idartikel;?>"><small class="form-text text-muted"></small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Judul</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="text-input" name="judul" placeholder="Enter Email" class="form-control" value="<?php echo $row->judul;?>"><small class="help-block form-text">Masukkan Judul</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="textarea-input" class=" form-control-label">Isi</label></div>
                                        <div class="col-12 col-md-9"><textarea name="isi" id="textarea-input" rows="9" placeholder="Content..." class="form-control"><?php echo $row->isi;?></textarea></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="password-input" class=" form-control-label">Penulis</label></div>
                                        <div class="col-12 col-md-9"><input readonly type="text" id="text-input" name="penulis" placeholder="Password" class="form-control" value="<?php echo $row->penulis;?>"><small class="help-block form-text">Nama Penulis</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Tanggal</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="text-input" name="tanggal" placeholder="Enter Email" class="form-control" value="<?php echo $row->tanggal;?>"><small class="help-block form-text">Masukkan Tanggal</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Kategori</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="text-input" name="kategori" placeholder="Enter Email" class="form-control" value="<?php echo $row->kategori;?>"><small class="help-block form-text">Masukkan Kategori</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Gambar</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="text-input" name="gambar" placeholder="Enter Email" class="form-control" value="<?php echo $row->gambar;?>"><small class="help-block form-text">Masukkan Lokasi Gambar</small></div>
                                    </div>
